# v0.0.25 (Sat Jan 28 2023)

#### ⚠️ Pushed to `master`

- chore: add .npmrc & disable lock files ([@sheriffMoose](https://github.com/sheriffMoose))
- chore: update auto plugins ([@sheriffMoose](https://github.com/sheriffMoose))
...
- remove lerna (mosherif87@gmail.com)
...
# v0.0.24 (Thu Jan 26 2023)

#### ⚠️ Pushed to `master`

- update auto config (mosherif87@gmail.com)
...
- updated yarn.lock ([@sheriffMoose](https://github.com/sheriffMoose))
- add more html/markdown demos ([@sheriffMoose](https://github.com/sheriffMoose))
...
- update author in package.json ([@sheriffMoose](https://github.com/sheriffMoose))
...
- update lerna.json ([@sheriffMoose](https://github.com/sheriffMoose))
- remove lock files ([@sheriffMoose](https://github.com/sheriffMoose))
- add lerna.json ([@sheriffMoose](https://github.com/sheriffMoose))
- delete lerna.json ([@sheriffMoose](https://github.com/sheriffMoose))
- update nx version ([@sheriffMoose](https://github.com/sheriffMoose))
- update storybook.yml ([@sheriffMoose](https://github.com/sheriffMoose))
- Update deploy.yml ([@sheriffMoose](https://github.com/sheriffMoose))
- Update storybook.yml ([@sheriffMoose](https://github.com/sheriffMoose))
- yarn.lock ([@sheriffMoose](https://github.com/sheriffMoose))
- update README.md ([@sheriffMoose](https://github.com/sheriffMoose))
- add variants logo ([@sheriffMoose](https://github.com/sheriffMoose))
- add toolbars logo ([@sheriffMoose](https://github.com/sheriffMoose))
- fix build script name ([@sheriffMoose](https://github.com/sheriffMoose))
- update logos ([@sheriffMoose](https://github.com/sheriffMoose))
- update readme ([@sheriffMoose](https://github.com/sheriffMoose))
- add workspace files ([@sheriffMoose](https://github.com/sheriffMoose))
...
- `@storybook-extras/swagger`
  - update openapi story file name ([@sheriffMoose](https://github.com/sheriffMoose))
...
- `@storybook-extras/console`, `@storybook-extras/markdown`, `@storybook-extras/preset`, `@storybook-extras/swagger`
...
- `@storybook-extras/markdown`, `@storybook-extras/swagger`
...
- `@storybook-extras/angular`, `@storybook-extras/markdown`, `@storybook-extras/preset`, `@storybook-extras/swagger`
  - updated readme ([@sheriffMoose](https://github.com/sheriffMoose))
- `@storybook-extras/angular`, `@storybook-extras/preset`
  - updates for preset addon & README ([@sheriffMoose](https://github.com/sheriffMoose))
- `@storybook-extras/angular`, `@storybook-extras/console`, `@storybook-extras/swagger`
...
- `@storybook-extras/angular`, `@storybook-extras/markdown`, `@storybook-extras/swagger`
